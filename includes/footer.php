        ...
        <div class="site-footer__grid">
            ...
            <div class="site-footer__column">
                ...
                <ul>
                    ...
                    <li><a href="support.php?lang=<?php echo $currentLang; ?>"><?php echo I18N::t('footer.faq', 'FAQ'); ?></a></li>
            ...
            <div class="site-footer__column">
                ...
                <ul>
                    <li><a href="support.php?lang=<?php echo $currentLang; ?>#privacy"><?php echo I18N::t('footer.privacy', 'Privacy Policy'); ?></a></li>
                    <li><a href="support.php?lang=<?php echo $currentLang; ?>#terms"><?php echo I18N::t('footer.terms', 'Terms & Conditions'); ?></a></li>
                    <li><a href="support.php?lang=<?php echo $currentLang; ?>#shipping"><?php echo I18N::t('footer.shipping', 'Shipping & Returns'); ?></a></li>
                </ul>
            </div>
